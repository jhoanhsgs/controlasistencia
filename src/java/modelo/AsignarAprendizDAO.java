...
public class AsignarAprendizDAO {
    ...
    public List ListarApendiz1(){
        String sql="SELECT * FROM `tbl_personas` WHERE PK_id_personas NOT IN (SELECT tbl_ficha_x_personas.FK_id_personas from tbl_ficha_x_personas where tbl_ficha_x_personas.FK_id_ficha=2) and FK_id_rol=2";
